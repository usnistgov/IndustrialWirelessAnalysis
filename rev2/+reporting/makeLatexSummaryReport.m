...
statarray = grpstats(ds,{'Site','Freq','RunType'},{'min','mean','max'},'DataVars',{'Mean_Delay_Spread_ns'});
export(statarray,'XLSfile','mobile_ds.xls')
matrix2latex(statarray(1:end,[1 2 3 5 6 7 ]), '../pub/spread.tex', 'columnLabels', ...
    {'Site','$f$ (GHz)','Route','$\mathbf{E}(min)$','$\mathbf{E}(mean)$','$\mathbf{E}(max)$'}, ...
        'format', '%-.1f', 'alignment', 'c') 
...
matrix2latex(statarray(1:end,[1 2 3 5 6 7]), '../pub/kfactor.tex', 'columnLabels', ... 
    {'Site','$f$ (GHz)','Route','$\mathbf{E}(mean)$','$\mathbf{E}(max)$','$\mathbf{E}(min)$'}, ...
        'format', '%-.1f', 'alignment', 'c') 
