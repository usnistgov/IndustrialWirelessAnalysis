...
matrix2latex(statarray(1:end,[1 2 3 5 6]), 'all.tex', 'columnLabels', ...
    {'Site','$f$ (GHz)','Route','Slope (dB/Hz)','Intercept (dB)', ...
...
export(statarray,'XLSfile','mobile_gain.xls')
matrix2latex(statarray(1:end,[1 2 3 5 6]), 'gain.tex', 'columnLabels', {'Site','$f$ (GHz)','Route','Slope (dB/Hz)','Intercept (dB)'}, 'format', '%-.1f', 'alignment', 'c')
...
matrix2latex(statarray(1:end,[1 2 3 5 6]), 'spread.tex', 'columnLabels', {'Site','$f$ (GHz)','Route','$\bar{\tau}$ (ns)','$\bar{S}$ (ns)'}, 'format', '%-.1f', 'alignment', 'c') 
...
matrix2latex(statarray(1:end,[1 2 3 5 6 7]), 'kfactor.tex', 'columnLabels', {'Site','$f$ (GHz)','Route','$\bar{K}$ (dB)','Max K (dB)','Min K (dB)'}, 'format', '%-.1f', 'alignment', 'c') 
...
filename = 'E:\FACTORY_MEASUREMENTS2\active_meas\stats.dat';
delimiter = '\t';
startRow = 2;
...
function cloudstats = cloud_stats()
%% Import data from text file.
% Script for importing data from the following text file:
%
...
%% Initialize variables.
filename = 'E:\FACTORY_MEASUREMENTS2\active_meas\cloud_stats.dat';
delimiter = '\t';
startRow = 2;
